...
EOF
    ...
    <CustomBuild Include="$grammarFile">
      ...
      <Command Condition="'\$(Configuration)|\$(Platform)'=='Debug|$self->{platform}'">"C:/Users/bugr2/AppData/Local/vcpkg/downloads/tools/perl/5.40.0.1/perl/bin/perl.exe" "src\\tools\\msvc\\pgbison.pl" "$grammarFile"</Command>
      ...
      <Command Condition="'\$(Configuration)|\$(Platform)'=='Release|$self->{platform}'">"C:/Users/bugr2/AppData/Local/vcpkg/downloads/tools/perl/5.40.0.1/perl/bin/perl.exe" "src\\tools\\msvc\\pgbison.pl" "$grammarFile"</Command>
...
EOF
    ...
    <CustomBuild Include="$grammarFile">
      ...
      <Command Condition="'\$(Configuration)|\$(Platform)'=='Debug|$self->{platform}'">"C:/Users/bugr2/AppData/Local/vcpkg/downloads/tools/perl/5.40.0.1/perl/bin/perl.exe" "src\\tools\\msvc\\pgflex.pl" "$grammarFile"</Command>
      <AdditionalInputs Condition="'\$(Configuration)|\$(Platform)'=='Debug|$self->{platform}'">%(AdditionalInputs)</AdditionalInputs>
      <Outputs Condition="'\$(Configuration)|\$(Platform)'=='Debug|$self->{platform}'">$outputFile;%(Outputs)</Outputs>
      <Message Condition="'\$(Configuration)|\$(Platform)'=='Release|$self->{platform}'">Running flex on $grammarFile</Message>
      <Command Condition="'\$(Configuration)|\$(Platform)'=='Release|$self->{platform}'">"C:/Users/bugr2/AppData/Local/vcpkg/downloads/tools/perl/5.40.0.1/perl/bin/perl.exe" "src\\tools\\msvc\\pgflex.pl" "$grammarFile"</Command>
      <AdditionalInputs Condition="'\$(Configuration)|\$(Platform)'=='Release|$self->{platform}'">%(AdditionalInputs)</AdditionalInputs>
      <Outputs Condition="'\$(Configuration)|\$(Platform)'=='Release|$self->{platform}'">$outputFile;%(Outputs)</Outputs>
    </CustomBuild>
EOF
...
EOF
    ...
    <PreLinkEvent>
      ...
      <Command>"C:/Users/bugr2/AppData/Local/vcpkg/downloads/tools/perl/5.40.0.1/perl/bin/perl.exe" src\\tools\\msvc\\gendef.pl --arch $arch --deffile $cfgname\\$self->{name}\\$self->{name}.def --tempdir $cfgname\\$self->{name} $cfgname\\$self->{name}</Command>
    </PreLinkEvent>
EOF
	}
	print $f <<EOF;
